                 ...
                 <div className="w-full lg:w-80 space-y-8 bg-slate-50 dark:bg-slate-800/50 p-8 rounded-[3rem] shadow-inner border border-slate-100 dark:border-slate-800">
                    <div className="space-y-4">
                       <div className="flex justify-between items-center px-1">
                          ...
                          <button type="button" onClick={() => setTargetClasses(targetClasses.length === ALL_CLASSES.length ? [] : [...ALL_CLASSES])} className="text-[8px] font-black text-slate-400 uppercase">Toggle All</button>
                       </div>
